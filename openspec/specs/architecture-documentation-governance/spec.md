# Architecture Documentation Governance Specification

## Purpose

Define the repository's requirements for evidence-backed feature and cross-feature subsystem
documentation while preserving the separate authority of OpenSpec, ADRs, conventions, code, and
tests.
