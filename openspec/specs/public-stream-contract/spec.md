# Public Stream Contract Specification

## Purpose

Define the credential-safe general stream representation, the intentional reservation credential
delivery boundary, and the frontend lifecycle behavior that must not depend on secret presence.
