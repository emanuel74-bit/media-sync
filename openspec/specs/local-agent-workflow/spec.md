...
Define the repository-local authorization, verification, review, evidence, archive, and merge
protocol for bounded agent-assisted changes while preserving user and coordinator authority.
